...
const conoce = track({
  id: "conoce",
  title: "Omni: anuncios en video, no un Reel “cool”",
  blurb: "10 lecciones, 4 horas: anuncios, redes y metraje que se ve filmado",
  scene: "camera",
  brand: O,
  pack: "omni",
  hook: [
    "Coursiv pone Omni en 10 lecciones y 4 horas, con tres oficios: anuncios en video, redes sociales y metraje realista. No es un oráculo de Reels. “Quiero algo viral / cinematic” no se filma. Un plano sí: sujeto, acción, segundos, un gesto de cámara.",
    "Omni (el motor de Kling / Kuaishou en este oficio) genera clips cortos de texto o de una foto. Coursiv lo lista para lifestyle, demo de producto y spots sin crew. Si el prompt es un párrafo de atmósfera, improvisa un comercial de perfume. Tú no puedes cortar eso en CapCut.",
  ],
  body: {
    title: "Qué es Omni en Coursiv",
    text: "Text-to-video e image-to-video de calidad cinematográfica para metraje promocional. Sirve cuando no hay presupuesto de rodaje. No escribe letras fiables en el frame. Los derechos comerciales hay que checarlos en los términos actuales antes de un anuncio de pago.",
  },
  bullets: [
    "Sujeto nombrado (no “una persona aesthetic”)",
    "Un verbo: camina, gira el termo, sonríe",
    "Duración y ratio del canal",
    "Un gesto de cámara, o fijo",
    "El claim y el precio van en caption, no generados en el aire",
  ],
  quiz: {
    question: "¿Qué describe mejor un clip para Omni?",
    options: [
      "Que se vea viral",
      "Segundos, movimiento de cámara y una acción",
      "Solo el nombre de la canción",
      "Un slogan escrito en el video",
    ],
    answer: 1,
    explain: "Se puede filmar. Lo viral no. El slogan se escribe en CapCut.",
  },
  practice: {
    title: "Completa el plano",
    lead: "Completa el pedido y mira cómo responde Omni en el workspace.",
    template: "Clip de {blank} segundos, cámara {blank}, el sujeto {blank}. Sin “viral”.",
    answers: ["5", "fija", "gira el termo"],
    slots: ["duración", "cámara", "acción"],
    resultImage: "/lessons/results/reel-producto.jpg",
    simReply: {
      intro: "5 s, fija, gira el termo. El baile se va a otro clip.",
      sections: [
        { title: "Qué filma Omni", text: "Un plano: el termo en la mano, un giro, cámara quieta." },
        { title: "Qué no filma", text: "El 2x1, el precio ni el audio. Eso lo pegas tú." },
      ],
    },
    review: {
      ...
      answer: 1,
      explain: "Un clip, un verbo. Coursiv: Omni no es tu timeline.",
    },
  },
  close: {
    tip: "habla como cámara: movimiento, duración y acción del sujeto.",
    items: ["10 lecciones, 4 horas", "Un plano, un verbo", "Cool no se filma"],
  },
});
...
const duracion = track({
  ...
  pack: "omni",
  hook: [
    "Omni te deja elegir duración (5 s, 10 s en muchos modos) y aspecto. Si no lo dices, recortas a ciegas y le cortas la cabeza al termo. Coursiv: el cajón primero, el adjetivo después.",
    "Un anuncio de 30 s no es un clip de Omni. Son varios planos de 5 s pegados en CapCut. Pedir 30 s de una sentada suele salir gelatina. En previews de modelos tipo Omni Flash el tope publicado ronda los 10 s: el hábito es el mismo, clip corto.",
  ],
  body: {
  ...
  quiz: {
    ...
    options: ["Al exportar, con fe", "Antes de generar", "Nunca, Omni adivina el canal"],
    answer: 1,
    explain: "Si no, recortas a ciegas.",
  },
  practice: {
    title: "Elige el cajón",
    lead: "Un clip. Un canal. Completa y mira la respuesta.",
    ...
    simReply: {
      intro: "5 s, 9:16. El termo subió. En 16:9 se veía sentado en mucha mesa.",
      sections: [
        { title: "Canal", text: "Reels come bordes. CTA lejos del filo derecho." },
        { title: "30 s", text: "Tres planos de 5 s en el editor. No un soplo de medio minuto." },
      ],
    },
    review: {
...
const camara = track({
  ...
  pack: "omni",
  hook: [
    "Omni entiende verbos de cámara si se los das uno. Dolly in al termo. Pan izquierda. Fijo. Motion control no salva un prompt que pide zoom + órbita + tilt + handheld a la vez: sale nauseabundo.",
    "Coursiv: un gesto. Si quieres otro, es otro clip. La “cámara de cine” no es una pila de palabras de Reddit de 2024. Metraje realista = un rig lento, no un drone + orbit + rack focus.",
  ],
  body: {
  ...
  bullets: [
    ...
    "El sujeto no compite con la cámara",
  ...
  quiz: {
    ...
    answer: 1,
    explain: "Tres a la vez se ve mareado. El metraje deja de verse realista.",
  },
  practice: {
    title: "Elige el rig",
    lead: "Un verbo. Completa y mira el plano.",
    ...
    simReply: {
      ...
      sections: [
        { title: "Clip 1", text: "Dolly in lento. Sujeto quieto. Se lee el SKU." },
        { title: "Clip 2", text: "Fija. El termo gira. Un verbo nuevo, otro archivo." },
      ],
    },
    review: {
      question: "¿El sujeto camina y la cámara orbita en el mismo clip?",
      options: ["Sí, más dinamismo", "No: o se mueve uno o se mueve la otra", "Solo si el modo se llama Omni"],
      answer: 1,
...
const i2v = track({
  ...
  blurb: "Una foto que ya sirve. Omni la mueve. No le pidas otra película",
  scene: "camera",
  brand: O,
  pack: "omni",
  hook: [
    "Image-to-video (Omni, Kling, Runway en el mismo oficio) parte de un still: el termo, la dueña, la paleta. Si la foto está sucia, el clip hereda el sucio y le suma deformación. Coursiv: eliges el frame como eliges el grid de Midjourney.",
    "El prompt de i2v dice el movimiento, no reescribe el producto. “Misma persona, dolly lento, el termo gira”. Si pides “ahora es un desierto al atardecer”, tiraste la ancla. Eso mata el metraje realista.",
  ],
  body: {
    title: "El still es el plano 0",
    text: "Foto nítida, sujeto grande, 9:16 si el clip es 9:16. Prompt: acción + cámara. Conserva ropa y objeto. Duración corta. Si el rostro se derrite, baja el motion o cambia de still. Referencia-a-video: la foto manda, el texto no inventa otro set.",
  },
  bullets: [
  ...
  practice: {
    ...
    lead: "La foto ya era el ad. Completa el gesto.",
    ...
    simReply: {
      ...
      sections: [
        { title: "Plano 0", text: "Still 9:16, termo grande, luz de ventana." },
        { title: "Motion", text: "Fija + giro lento. Sin cambio de set." },
      ],
    },
    review: {
  ...
  close: {
    tip: "el still es el plano. Omni lo mueve. No le pidas otra película.",
...
const anclas = track({
  ...
  pack: "omni",
  hook: [
    "Tres anclas concretas para que no mute entre generados: camisa naranja, pelo corto negro, termo mate en la mano. “La misma chica cool” no es un ancla. Coursiv lo repite en Omni: el corte grita si el extra de gorra aparece en el clip 2.",
    "Image-to-video hereda anclas de la foto. Text-to-video las necesita escritas, cada clip. Copia el bloque. No lo reescribas de memoria. Metraje realista = la misma persona, el mismo SKU.",
  ],
  body: {
    title: "Tres cosas que no cambian",
    text: "Ropa, pelo, objeto (el SKU). Luz de la escena si es la misma toma. Las transiciones se piden aparte. Un extra que no estaba en las anclas: fuera.",
  },
  bullets: [
    "Ropa (color + prenda)",
  ...
  practice: {
    ...
    lead: "Tres cosas que no cambian. Completa y mira el corte.",
    ...
    simReply: {
      intro: "El termo se quedó. El extra de gorra no estaba en las anclas: fuera.",
      sections: [
        { title: "Bloque para copiar", text: "Camisa naranja, pelo corto negro, termo mate en la mano, luz de ventana." },
        { title: "Clip 2", text: "Mismo bloque. Otro verbo. Sin extras." },
      ],
    },
    review: {
...
const corte = track({
  ...
  blurb: "Omni no edita el anuncio. CapCut sí. Tú pegas",
  scene: "camera",
  brand: O,
  pack: "omni",
  hook: [
    "Un clip, un verbo. “La persona cocina, baila y saluda” no se sostiene. Coursiv: generas plano A, plano B, plano C. El corte, el texto en pantalla y el audio viven en CapCut, Premiere o el editor de Reels. Omni no es tu timeline.",
    "Coursiv (marketing 2026): el híbrido gana. Omni entrega fondo y metraje; una persona real puede poner la voz. Si pides la transición “morph al siguiente look” en el mismo prompt, suele salir un accidente. Corta en duro.",
  ],
  body: {
  ...
  bullets: [
    ...
    "Audio y captions después — voz real si puedes",
  ],
  quiz: {
    question: "¿Quién hace el corte?",
    options: ["Omni, si se lo pides lindo", "Tú, en el editor, con clips de un verbo", "El algoritmo de TikTok"],
    answer: 1,
    explain: "Omni filma el plano. El montaje es otro oficio.",
  },
  practice: {
    title: "Arma tres planos",
    lead: "Gancho, demo, CTA. Completa el storyboard.",
    ...
    simReply: {
      ...
      sections: [
        { title: "Gancho", text: "Termo en mesa, 5 s, fija." },
        { title: "Demo", text: "Giro + dolly in. Mismas anclas." },
        { title: "CTA", text: "Fija. El “Pedir” y el precio van en caption, no en el frame." },
      ],
    },
    review: {
      question: "¿Pides el anuncio entero en un prompt?",
      options: ["Sí, para “flujo”", "No: un clip, un verbo; el corte después", "Solo en modo Omni"],
      answer: 1,
...
const ads = track({
  ...
  pack: "omni",
  hook: [
    "Un ad de Meta o un UGC de 15 s no es “cinematic storytelling”. Es: producto a los 2 s, demo, CTA. Omni entrega la imagen en movimiento. El claim (“no suda en la combi”) lo escribes tú en captions. Coursiv: el texto en video generado es poco fiable.",
    "Mismos hechos que el copy de Jasper. El clip no inventa un 2x1 que el brief no tenía. Antes de un anuncio de pago, confirma derechos de uso comercial del generador.",
  ],
  body: {
  ...
  bullets: [
    ...
    "Derechos comerciales: léelos antes de pautar",
  ],
  quiz: {
  ...
  practice: {
    title: "Brief del ad",
    lead: "Un claim. Un CTA. Completa y mira el corte.",
    ...
    simReply: {
      ...
      sections: [
        { title: "Beat 1", text: "Termo 500 ml en la combi. 2 s. Se entiende el SKU." },
        { title: "Beat 2", text: "La mano: no suda. Un gesto, no un discurso." },
        { title: "Beat 3", text: "Pedir. Caption: precio real del brief. Sin letras de Omni." },
      ],
    },
    review: {
      question: "¿Omni escribe el “349 MXN” en el video?",
      options: ["Sí, para que se lea", "No: captions o Canva; el modelo inventa letras", "Solo en 9:16"],
      answer: 1,
      explain: "Coursiv: el texto en frame no se sostiene. El post se escribe aparte.",
    },
  },
  close: {
...
const social = track({
  ...
  pack: "omni",
  hook: [
    "Si el anuncio vive en Instagram Reels o TikTok, generas 9:16. Un master 16:9 recortado a tijera le come la frente al sujeto. Coursiv: un archivo por canal. Omni deja elegir el aspecto; úsalo.",
    "Safe area: caras y termo al centro-arriba. La UI de Reels (botones a la derecha, caption abajo) se come los bordes. No pongas el CTA pegado al filo.",
  ],
  body: {
  ...
  practice: {
    ...
    lead: "Un lienzo. Completa el recuadro.",
    ...
    simReply: {
      ...
      sections: [
        { title: "Safe area", text: "Producto centro-arriba. Nada pegado al filo derecho ni abajo." },
        { title: "Otro canal", text: "YouTube = otra generación 16:9. No recortes este archivo." },
      ],
    },
    review: {
...
const artefactos = track({
  ...
  pack: "omni",
  hook: [
    "Omni (y cualquier i2v) inventa: dientes que bailan, un tercer dedo, el termo que se vuelve vaso, texto fantasma. Coursiv cierra con ojo de editor: reproduces a 1×, luego a 0.5×. Si a la mitad muta, tiras el clip o recortas antes del accidente.",
    "Más segundos = más tiempo para que se rompa. Por eso 5 s gana a 10 si el gesto ya se leyó. Metraje “realista” se cae en cuanto el SKU mutea.",
  ],
  body: {
  ...
  practice: {
    ...
    lead: "Tres cazas. Completa la pasada.",
    ...
    simReply: {
      ...
      sections: [
        { title: "Cara", text: "A 0.5× el diente bailaba. Recorte en 3.8 s." },
        { title: "SKU", text: "El termo sigue siendo el de la foto. Si mutea, el clip no sube." },
      ],
    },
    review: {
...
const revision = track({
  ...
  blurb: "Omni no firma el anuncio. Claims, audio y recorte los valida una persona",
  scene: "camera",
  brand: O,
  pack: "omni",
  hook: [
    "Coursiv cierra Omni con el mismo editor que en Jasper: factual, de marca y de canal. Un clip “bonito” puede seguir mintiendo un 2x1 o verse cortado en Reels. Tú pegas captions, música con licencia y das publicar.",
    "Checklist corta. Si una casilla falla, no sube. Da igual que el dolly haya quedado de revista. Confirma derechos de uso si el clip va a pauta.",
  ],
  body: {
  ...
  bullets: [
    ...
    "Derechos comerciales si hay pauta",
  ],
  quiz: {
  ...
  practice: {
    ...
    lead: "Cuatro casillas. Completa y mira el cierre.",
    ...
    simReply: {
      ...
      sections: [
        { title: "Pasa", text: "Misma persona, mismo termo, 9:16, CTA visible." },
        { title: "No pasa", text: "2x1 que el brief no tenía. Caption sin precio inventado." },
        { title: "Tú", text: "Música con licencia. Publicar. Omni no toca Instagram." },
      ],
    },
    review: {
      question: "¿Omni publica solo en Instagram?",
      options: [
        "Sí, para “escalar”",
        "No: tú exportas, pones caption y das publicar",
        "Solo si el modo está en auto",
      ],
      answer: 1,
  ...
  close: {
    ...
    items: ["Anclas al día", "Tres clips, un corte", "Omni acelera. No publica"],
  },
});

export const omniUnits = [
  { id: "u1", title: "El plano y el metraje", lessons: [conoce, duracion, camara, i2v, anclas] },
  { id: "u2", title: "Anuncios y redes", lessons: [corte, ads, social, artefactos, revision] },
];
